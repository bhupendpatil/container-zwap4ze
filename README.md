...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zwap4ze.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zwap4ze.containers.anotherwebservice.com/
...
```
git clone git@github.com:bhupendpatil/container-zwap4ze.git
cd container-zwap4ze
```
...
```
docker attach container-zwap4ze
```
